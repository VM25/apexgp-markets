...
export default function ResearchTab({
  ...
  return (
    <div className="h-full flex flex-col xl:flex-row gap-3.5 select-none min-h-[520px] font-mono text-[10px] text-slate-400">
      ...
      <div className="w-full xl:w-56 shrink-0 flex flex-row xl:flex-col gap-1 select-none">
        <div className="bg-carbon-surface border border-white/5 rounded p-2.5 space-y-1 w-full flex flex-col shrink-0">
          <span className="text-[7px] text-slate-500 font-bold uppercase tracking-wider block">Desk Document Index</span>
          <span className="text-white font-extrabold text-[9.5px] uppercase tracking-wider block leading-tight">
            RESEARCH MEMO CL-9
          </span>
        </div>
        ...
        <div className="flex-1 flex flex-row xl:flex-col gap-0.5 overflow-x-auto xl:overflow-x-visible xl:overflow-y-auto mt-2 w-full">
          {sections.map((s) => (
            <button
              ...
              className={`px-3 py-2 text-left font-bold rounded text-[9.5px] cursor-pointer transition-all flex items-center gap-2 shrink-0 ${activeNarrativeSection === s.id ? "bg-terminal-blue/15 border-l-2 border-terminal-blue text-white" : "bg-white/3 hover:bg-white/5 text-slate-400"}`}
            >
              {s.icon}
              {s.title}
            </button>
      ...
      <div className="flex-1 bg-carbon-surface border border-white/5 rounded p-4 flex flex-col min-h-0 select-text">
        <div className="flex justify-between items-center border-b border-white/5 pb-2 mb-3.5 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-white font-bold text-[10.5px] uppercase tracking-wider">
              {sections.find(s => s.id === activeNarrativeSection)?.title}
            </h2>
          </div>
          <span className="text-[7.5px] text-slate-500 font-bold tracking-wider uppercase font-mono">CONFIDENTIAL RESEARCH SYSTEM REPORT</span>
        </div>

        <div className="flex-1 overflow-y-auto min-h-0 pr-1 leading-relaxed text-[10.5px] font-sans font-light text-slate-350 space-y-3.5">
          
          {activeNarrativeSection === "thesis" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">I. PROJECT THESIS // THE MACRO TRANSITION</span>
              <p>
              ...
              <ul className="list-disc pl-5 space-y-1 mt-1 text-slate-300 font-mono text-[9.5px]">
              ...
              <div className="bg-carbon-black/40 border border-white/5 p-3 rounded font-mono text-[9px] text-slate-400 mt-2 space-y-1 leading-normal">
                <span className="text-terminal-blue font-bold uppercase text-[7.5px] tracking-wider block">UI Connectivity</span>
          ...
          {activeNarrativeSection === "why-f1" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">II. WHY FORMULA 1 // THE TELEMETRY DEEP STREAM</span>
              <p>
              ...
              <div className="grid grid-cols-2 gap-3 text-center my-2 font-mono text-[9px]">
                <div className="bg-carbon-black p-2.5 rounded border border-white/5">
                  ...
                  <span className="text-slate-550 block text-[7.5px] mt-0.5">Degradation rate increases probability of thermal failure (DNF).</span>
                </div>
                <div className="bg-carbon-black p-2.5 rounded border border-white/5">
                  ...
                  <span className="text-slate-555 block text-[7.5px] mt-0.5">Option chain bid-ask spreads widen on risk limit warnings.</span>
                </div>
              </div>
              <p>
          ...
          {activeNarrativeSection === "architecture" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">III. MARKET ARCHITECTURE // TWO-SIDED DECIMAL AMM CHAIN</span>
              <p>
              ...
              <div className="bg-carbon-black/60 border border-white/5 p-3 rounded text-[9.5px] font-mono leading-relaxed space-y-1 my-2">
          ...
          {activeNarrativeSection === "probability" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">IV. PROBABILITY ENGINE // BAYESIAN DYNAMICS</span>
              <p>
              ...
              <div className="bg-carbon-black/60 border border-white/5 p-3.5 rounded text-[9.5px] font-mono leading-relaxed space-y-2.5 my-2 text-slate-300">
          ...
          {activeNarrativeSection === "risk" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">V. RISK CONTROLS // DESK EXPOSURE MANAGEMENT</span>
              <p>
          ...
          {activeNarrativeSection === "portfolio" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">VI. PORTFOLIO DESIGN // MARK-TO-MARKET VALUATION</span>
              <p>
              ...
              <div className="bg-carbon-black/60 border border-white/5 p-3.5 rounded text-[9.5px] font-mono leading-relaxed space-y-2 my-2 text-slate-350">
          ...
          {activeNarrativeSection === "replay" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">VII. REPLAY PHILOSOPHY // SYSTEMATIC QUANT BACKTESTING</span>
              <p>
          ...
          {activeNarrativeSection === "quant" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">VIII. QUANT CONCEPTS // MICROSTRUCTURE MECHANICS</span>
              <p>
              ...
              <div className="space-y-3 text-[9.5px] font-sans text-slate-300">
                <div>
                  <strong className="text-white block font-mono text-[9px] uppercase text-terminal-blue-light">1. Price Sensitivity (Delta Δ)</strong>
                ...
                <div className="pt-2 border-t border-white/5">
                  <strong className="text-white block font-mono text-[9px] uppercase text-terminal-blue-light">2. Time Decay (Theta Θ)</strong>
                ...
                <div className="pt-2 border-t border-white/5">
                  <strong className="text-white block font-mono text-[9px] uppercase text-terminal-blue-light">3. Implied Volatility Index (IV)</strong>
          ...
          {activeNarrativeSection === "lessons" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">IX. LESSONS LEARNED // MICROSTRUCTURE IMPLICATIONS</span>
              <p>
          ...
          {activeNarrativeSection === "demonstration" && (
            <div className="space-y-3">
              <span className="text-slate-500 font-bold font-mono uppercase text-[8px] tracking-wider block">X. WHAT THIS DEMONSTRATES // SYSTEM SUMMARY</span>
              <p>
                ApexGP is a comprehensive demonstrator of high-velocity, high-density microstructure engineering:
              </p>
              <div className="grid grid-cols-2 gap-3 text-slate-300 font-mono text-[9px] my-2 select-text">
